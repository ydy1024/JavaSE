package com.ydy._01网络通信的基本概念;

/**
    目标：网络通信的分层和协议。

    网络通信协议：通信协议是对计算机必须遵守的规则，
        只要遵守这些规则，计算机之间才能进行通信。

    ----------------------------------------------------------------------
    应用层：应用程序（QQ，微信，浏览器），可能用到的协议（HTTP，FTP，SMTP）通常程序员要关心这些。
    ------------------------------------------------------------------------
    传输层：TCP/IP协议 - UDP协议         计算机网络工程师需要精通的协议，有些技术我们也需要精通这一层，以后再学习。
    --------------------------------------------------------------------------
